...
nn.addLayer(NetLayer.new(data_x.size_x, 64, ActivFunc::ReLu, lrn: 0.0005))
nn.addLayer(NetLayer.new(64, 12, ActivFunc::ReLu, lrn: 0.0005))
nn.addLayer(NetLayer.new(12, 1, ActivFunc::ReLu, lrn: 0.0005))

(0...3500).each do |ep|
	batch_x, batch_y = train.batch(data_y, data_x: data_x, batch_size: 5)
	it = 120000
	(0..it).each do |i|
